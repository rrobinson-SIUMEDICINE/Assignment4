...
Companies like Fitbit, Nike, and Jawbone Up are racing to develop the most advanced algorithms to attract new users. The data linked to from the course website represent
...
1. Create github repository for the dataset.
2. Download [Compressed Dataset](https://d396qusza40orc.cloudfront.net/getdata%2Fprojectfiles%2FUCI%20HAR%20Dataset.zip)
3. Unzip datafile and move the directory `UCI HAR Dataset` to the repository root directory.
4. Launch Rstudio and set working directory to the repository root directory.
5. Execute the `run_analisys.R` script (required libraries will load in script) 
